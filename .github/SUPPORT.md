# Getting help with `gamblr`

Thank you for using `gamblr`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/gamblr`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/gamblr),
...
[search issues and pull requests](https://github.com/gtwa-bio/gamblr/issues)
